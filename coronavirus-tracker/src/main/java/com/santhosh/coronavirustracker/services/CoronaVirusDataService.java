package com.santhosh.coronavirustracker.services;
...
public class CoronaVirusDataService {
    ...
    @PostConstruct          //execute this when the application starts
    @Scheduled(cron = "* * 1 * * *")
    public void fetchVirusData() throws IOException, InterruptedException {
        ...
        for (CSVRecord record : records) {
            ...
            locationStats.setDiffFromPrevious(Integer.parseInt(record.get(record.size()-1))-Integer.parseInt(record.get(record.size()-2)));
